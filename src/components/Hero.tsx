  ...
  return (
    <section className="relative overflow-hidden pb-[88px] pt-[72px]" id="top">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(900px 520px at 78% 8%, rgba(255,217,190,0.65), rgba(255,217,190,0) 60%), radial-gradient(700px 480px at 10% 30%, rgba(255,244,236,0.9), rgba(255,244,236,0) 60%)',
        }}
      />
      <span className="pointer-events-none absolute right-[4%] top-[8%] -z-10 h-[220px] w-[220px] rounded-full opacity-50 blur-lg [background:radial-gradient(circle_at_30%_30%,#FFD9BE,rgba(255,176,122,.1))]" />
      <span className="pointer-events-none absolute -left-10 bottom-[6%] -z-10 h-40 w-40 rounded-full opacity-50 blur-lg [background:radial-gradient(circle_at_30%_30%,rgba(255,176,122,.5),rgba(255,176,122,0))]" />
