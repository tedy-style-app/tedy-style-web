...
export default function HowItWorks() {
  const { t } = useLang()
  return (
    <section className="bg-peach-tint py-24" id="how">
          ...
          {t.how.steps.map((step, i) => (
            <Fragment key={step.title}>
              <Reveal delay={(i % 3) as 0 | 1 | 2} className="px-3.5 text-center">
                <div className="mx-auto mb-[22px] grid h-[60px] w-[60px] place-items-center rounded-full bg-grad-primary text-2xl font-black text-white shadow-glow">
                  {i + 1}
                </div>
              ...
              {i < t.how.steps.length - 1 && (
                <div
                  ...
                  style={{
                    background:
                      'repeating-linear-gradient(90deg,#FFB07A 0 7px,transparent 7px 14px)',
                  }}
                />
              )}
            </Fragment>
