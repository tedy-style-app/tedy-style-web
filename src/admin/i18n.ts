...
const dict = {
  ...
  // ---- AI Usage ----
  'nav.aiUsage': { ru: 'AI использование', uz: 'AI ishlatilishi', en: 'AI Usage' },
  'aiUsage.title': { ru: 'AI использование', uz: 'AI ishlatilishi', en: 'AI Usage' },
  'aiUsage.subtitle': {
    ru: 'Журнал вызовов AI: токены, стоимость и статус',
    uz: 'AI chaqiruvlari jurnali: tokenlar, narx va status',
    en: 'AI call log: tokens, cost and status',
  },
  'aiUsage.empty': { ru: 'Вызовов AI пока нет', uz: "Hozircha AI chaqiruvlari yo'q", en: 'No AI calls yet' },
  'aiUsage.system': { ru: 'Система', uz: 'Tizim', en: 'System' },
  // Stat cards
  'aiUsage.stat.calls': { ru: 'Всего вызовов', uz: 'Jami chaqiruvlar', en: 'Total calls' },
  'aiUsage.stat.success': { ru: 'Успешных', uz: 'Muvaffaqiyatli', en: 'Success' },
  'aiUsage.stat.failed': { ru: 'Ошибок', uz: 'Xatoliklar', en: 'Failed' },
  'aiUsage.stat.tokens': { ru: 'Всего токенов', uz: 'Jami tokenlar', en: 'Total tokens' },
  'aiUsage.stat.cost': { ru: 'Общая стоимость', uz: 'Umumiy narx', en: 'Total cost' },
  // Charts
  'aiUsage.chart.costOverTime': { ru: 'Стоимость по дням', uz: "Kunlar bo'yicha narx", en: 'Cost over time' },
  'aiUsage.chart.byProvider': { ru: 'По провайдерам', uz: "Provayderlar bo'yicha", en: 'By provider' },
  'aiUsage.chart.byOperation': { ru: 'По операциям', uz: "Operatsiyalar bo'yicha", en: 'By operation' },
  // Table columns
  'aiUsage.col.time': { ru: 'Время', uz: 'Vaqt', en: 'Time' },
  'aiUsage.col.operation': { ru: 'Операция', uz: 'Operatsiya', en: 'Operation' },
  'aiUsage.col.provider': { ru: 'Провайдер', uz: 'Provayder', en: 'Provider' },
  'aiUsage.col.model': { ru: 'Модель', uz: 'Model', en: 'Model' },
  'aiUsage.col.status': { ru: 'Статус', uz: 'Status', en: 'Status' },
  'aiUsage.col.tokens': { ru: 'Токены', uz: 'Tokenlar', en: 'Tokens' },
  'aiUsage.col.cost': { ru: 'Стоимость', uz: 'Narx', en: 'Cost' },
  'aiUsage.col.duration': { ru: 'Время', uz: 'Davomiyligi', en: 'Duration' },
  'aiUsage.col.user': { ru: 'Пользователь', uz: 'Foydalanuvchi', en: 'User' },
  // Status slugs
  'aiUsage.status.success': { ru: 'Успех', uz: 'Muvaffaqiyat', en: 'Success' },
  'aiUsage.status.failed': { ru: 'Ошибка', uz: 'Xatolik', en: 'Failed' },
  'aiUsage.status.rejected': { ru: 'Отклонено', uz: 'Rad etilgan', en: 'Rejected' },
  // Filters
  'aiUsage.filter.all': { ru: 'Все', uz: 'Hammasi', en: 'All' },
  'aiUsage.filter.provider': { ru: 'Провайдер', uz: 'Provayder', en: 'Provider' },
  'aiUsage.filter.operation': { ru: 'Операция', uz: 'Operatsiya', en: 'Operation' },
  'aiUsage.filter.status': { ru: 'Статус', uz: 'Status', en: 'Status' },
  'aiUsage.filter.modelPlaceholder': { ru: 'Модель', uz: 'Model', en: 'Model' },
  'aiUsage.filter.userPlaceholder': { ru: 'ID пользователя', uz: 'Foydalanuvchi ID', en: 'User ID' },
  'aiUsage.filter.searchPlaceholder': {
    ru: 'Поиск: операция / модель / ошибка',
    uz: 'Qidiruv: operatsiya / model / xatolik',
    en: 'Search: operation / model / error',
  },
  'aiUsage.filter.search': { ru: 'Найти', uz: 'Topish', en: 'Search' },
  // Drawer
  'aiUsage.drawer.title': { ru: 'Вызов AI', uz: 'AI chaqiruvi', en: 'AI call' },
  'aiUsage.drawer.loadError': { ru: 'Не удалось загрузить запись.', uz: "Yozuvni yuklab bo'lmadi.", en: 'Failed to load the record.' },
  // Section headings
  'aiUsage.section.error': { ru: 'Ошибка', uz: 'Xatolik', en: 'Error' },
  'aiUsage.section.prompt': { ru: 'Промпт', uz: 'Prompt', en: 'Prompt' },
  'aiUsage.section.requestParams': { ru: 'Параметры запроса', uz: "So'rov parametrlari", en: 'Request params' },
  'aiUsage.section.responsePayload': { ru: 'Ответ', uz: 'Javob', en: 'Response payload' },
  'aiUsage.section.inputImages': { ru: 'Входные изображения', uz: 'Kirish rasmlari', en: 'Input images' },
  'aiUsage.section.outputImages': { ru: 'Выходные изображения', uz: 'Chiqish rasmlari', en: 'Output images' },
  // Info labels
  'aiUsage.info.created': { ru: 'Создано', uz: 'Yaratilgan', en: 'Created' },
  'aiUsage.info.started': { ru: 'Начало', uz: 'Boshlangan', en: 'Started' },
  'aiUsage.info.finished': { ru: 'Завершено', uz: 'Tugagan', en: 'Finished' },
  'aiUsage.info.duration': { ru: 'Длительность', uz: 'Davomiyligi', en: 'Duration' },
  'aiUsage.info.durationValue': { ru: '{n} мс', uz: '{n} ms', en: '{n} ms' },
  'aiUsage.info.user': { ru: 'Пользователь', uz: 'Foydalanuvchi', en: 'User' },
  'aiUsage.info.context': { ru: 'Контекст', uz: 'Kontekst', en: 'Context' },
  'aiUsage.info.model': { ru: 'Модель', uz: 'Model', en: 'Model' },
  'aiUsage.info.provider': { ru: 'Провайдер', uz: 'Provayder', en: 'Provider' },
  'aiUsage.info.inputTokens': { ru: 'Входные токены', uz: 'Kirish tokenlari', en: 'Input tokens' },
  'aiUsage.info.outputTokens': { ru: 'Выходные токены', uz: 'Chiqish tokenlari', en: 'Output tokens' },
  'aiUsage.info.totalTokens': { ru: 'Всего токенов', uz: 'Jami tokenlar', en: 'Total tokens' },
  'aiUsage.info.textTokens': { ru: 'Текстовые токены', uz: 'Matn tokenlari', en: 'Text tokens' },
  'aiUsage.info.imageTokens': { ru: 'Токены изображений', uz: 'Rasm tokenlari', en: 'Image tokens' },
  'aiUsage.info.cost': { ru: 'Стоимость', uz: 'Narx', en: 'Cost' },
  // Toggle + misc
  'aiUsage.toggle.show': { ru: 'Показать', uz: "Ko'rsatish", en: 'Show' },
  'aiUsage.toggle.hide': { ru: 'Скрыть', uz: 'Yashirish', en: 'Hide' },
  'aiUsage.noImages': { ru: 'Нет изображений', uz: "Rasmlar yo'q", en: 'No images' },
